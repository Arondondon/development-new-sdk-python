...
class MetadataProvider(abc.ABC):
    ...
    @abc.abstractmethod
    def enhance_service_group_details(self, service_metadata, org_metadata):
        raise NotImplementedError()


class IPFSMetadataProvider(MetadataProvider):
...
class FileCoinProvider(MetadataProvider):
    def fetch_org_metadata(self,org_id):
        pass
